...
class TestSwarmRunHistory:
    ...
    async def test_history_records_launch(self, client, mock_project_folder):
    ...
    async def test_history_records_stop(self, client, mock_project_folder):
    ...
    async def test_history_multiple_runs(self, client, mock_project_folder):
    ...
    async def test_history_ordered_by_started_at_desc(self, client, mock_project_folder):
    ...
    async def test_history_isolated_per_project(self, client, mock_project_folder, tmp_path):
    ...
    async def test_history_run_has_all_fields(self, client, mock_project_folder):
